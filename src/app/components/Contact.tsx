...
const copy = {
  ...
  hi: {
    eyebrow: "KAG परिवार से जुड़ें",
    title: (
      <>
        परिवार से जुड़ने में <em className="text-[#ff7900] not-italic">देरी कैसी?</em>
      </>
    ),
    body: "असली प्रोडक्ट, ईमानदार कीमत और जवाब जो सच में जल्दी आता है—यही मिलता है डीलर को पहले दिन से। सत्ताईस साल बाद भी, दुकानदार आज भी नाम लेकर KAG ही मांगते हैं।",
    successLabel: "मैसेज मिल गया",
    successTitle: "धन्यवाद। KAG टीम जल्द संपर्क करेगी।",
    ...
    whatsappMessage: "नमस्ते KAG Batteries, मुझे आपके प्रोडक्ट्स के बारे में और जानना है।",
  },
};
