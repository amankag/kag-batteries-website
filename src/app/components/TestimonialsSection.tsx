  ...
  hi: [
    {
      ...
      quote:
        "KAG की टॉर्च हम सालों से बेच रहे हैं। क्वालिटी एकदम असली है, ग्राहक कभी शिकायत लेकर वापस नहीं आते। इसीलिए हम सिर्फ KAG पर भरोसा करते हैं।",
    },
    {
      name: "सुनीता देशमुख",
      ...
      quote:
        "सबसे अच्छी बात है समय पर डिलीवरी, हर बार। जितनी भी क्वांटिटी ऑर्डर करें, KAG टीम बिना किसी टेंशन के मैनेज कर देती है। बहुत प्रोफेशनल लोग हैं।",
    },
    {
      name: "राजेंद्र यादव",
      role: "होलसेल डीलर",
      ...
      quote:
        "सीधे फैक्ट्री से मिलता है, इसलिए कीमत हमेशा सही रहती है। अब मेरे ग्राहक नाम लेकर KAG मांगते हैं—यही दिखाता है कि हमने साथ में कितना भरोसा बनाया है।",
    },
    {
      ...
      quote:
        "गांवों में भी बिजली कटौती आम समस्या है। यहां किसानों की पहली पसंद KAG टॉर्च ही है—बैटरी बैकअप ज़बरदस्त है और कीमत भी उनके हिसाब से सही है।",
    },
    {
      name: "फ़रीदा शेख",
...
const headingCopy = {
  ...
  hi: {
    ...
    body: "इंदौर से लेकर महाराष्ट्र और मध्य प्रदेश के काउंटरों तक—जो लोग रोज़ KAG बेचते हैं, वे क्या कहते हैं।",
  },
};
